...
# Configuration - replace with your SonarCloud details
SONAR_TOKEN = "** SONAR_TOKEN**"  # Get from SonarCloud user settings
PROJECT_KEY = "** PROJECT_KEY**"  # Found in SonarCloud project dashboard
